...
export default function Filters() {
  ...
  const searchTextSelector = useSelector(todoRemainingSelector);
  console.log(searchTextSelector, 'searchTextSelector');
  ...
  return (
    <Row justify='center'>
      <Col span={24}>
        ...
        <Search placeholder='input search text' value={searchText} onChange={handSearchTextChange} />
      </Col>
      <Col sm={24}>
        <Typography.Paragraph
          style={{ fontWeight: 'bold', marginBottom: 3, marginTop: 10 }}
